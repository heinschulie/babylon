...
import { g as goto, p as page } from "../../chunks/index4.js";
import { B as Button } from "../../chunks/button.js";
import { i as isAuthenticated } from "../../chunks/auth.js";
import { s as setupConvex } from "../../chunks/client.svelte.js";
import "clsx";
...
function Header($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<header class="app-header"><div class="page-shell page-shell--narrow !py-3 sm:!py-4"><div class="app-header__stack"><div class="app-header__top"><a${attr("href", resolve("/"))} class="app-header__brand"><span class="info-kicker">Daily Language Recall</span> <span class="app-header__title">Recall</span></a></div> `);
    if (store_get($$store_subs ??= {}, "$isAuthenticated", isAuthenticated)) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="app-header__rail"><nav class="app-header__nav" aria-label="Primary"><a${attr("href", resolve("/"))} class="app-header__link"${attr("data-active", isActive("/"))}>Library</a> <a${attr("href", resolve("/practice"))} class="app-header__link"${attr("data-active", isActive("/practice"))}>Practice</a> <a${attr("href", resolve("/settings"))} class="app-header__link"${attr("data-active", isActive("/settings"))}>Settings</a></nav> `);
      Button($$renderer2, {
        variant: "outline",
        size: "sm",
