      ...
      Card?.($$renderer3, {
        ...
        children: ($$renderer4) => {
          ...
          Card_header?.($$renderer4, {
            children: ($$renderer5) => {
              $$renderer5.push(`<p class="info-kicker">Start Quickly</p> <!---->`);
              ...
              Card_description?.($$renderer5, {
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->Set up in under a minute, then activate your verifier profile.`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
          ...
          Card_footer?.($$renderer4, {
            ...
            children: ($$renderer5) => {
              $$renderer5.push(`<p class="meta-text">Already have an account? <a${attr("href", resolve("/login"))} class="text-primary underline">Sign in</a></p>`);
            },
            $$slots: { default: true }
          });
          $$renderer4.push(`<!---->`);
