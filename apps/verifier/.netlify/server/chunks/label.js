import { b as attributes, c as clsx, d as bind_props, f as derived, p as props_id, g as spread_props } from "./index2.js";
import { c as cn } from "./button.js";
import { a7 as ATTACHMENT_KEY, a8 as run } from "./context.js";
...
function Card($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attributes({
      "data-slot": "card",
      class: clsx(cn("bg-transparent text-card-foreground flex flex-col gap-5 py-5 sm:py-6", className)),
      ...restProps
    })}>`);
    children?.($$renderer2);
    $$renderer2.push(`<!----></div>`);
