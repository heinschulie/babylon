...
LEARNINGS_FILE: .claude/commands/experts/frontend/learnings.yaml
...
1d. **Enforce Durable Learnings in Expertise**
   ...
   - For each entry, verify it is reflected in the appropriate section of EXPERTISE_FILE (platform_constraints, best_practices, known_issues, or quality_gates)
